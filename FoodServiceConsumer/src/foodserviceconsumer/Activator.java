...
import foodserviceproducer.FoodServiceInterface;
...
public class Activator implements BundleActivator {
	...
	public void start(BundleContext context) throws Exception {
		System.out.println("Food Service Consumer started");
	...
	public void stop(BundleContext context) throws Exception {
		System.out.println("Food Service Consumer stopped");
	...
	public void displayMainMenu(FoodServiceInterface foodServiceInterface) {
		...
		System.out.println("\n\n");
		System.out.println("----------FoodZilla Family Restaurant - Admin Order Section ----------");
