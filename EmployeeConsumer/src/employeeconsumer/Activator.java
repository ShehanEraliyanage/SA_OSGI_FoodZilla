...
import employeeproducer.EmployeeInterface;
...
public class Activator implements BundleActivator {
	...
	public void start(BundleContext context) throws Exception {
		System.out.println("Employee Consumer Service started");
	...
	public void stop(BundleContext context) throws Exception {
		System.out.println("Employee Consumer Service stopped");
	...
	public void displayMainMenu(EmployeeInterface employeeInterface) {
		...
		System.out.println("\n\n");
		System.out.println("----------FoodZilla Family Restaurant----------");
