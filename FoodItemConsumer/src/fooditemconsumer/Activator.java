...
import fooditemproducer.FoodItemInterface;
...
public class Activator implements BundleActivator {
	...
	public void start(BundleContext context) throws Exception {
		System.out.println("FoodItem Consumer Service started");
	...
	public void stop(BundleContext context) throws Exception {
		System.out.println("FoodItem Consumer Service stopped");
	...
	public void displayMainMenu(FoodItemInterface foodItemInterface) {
		...
		System.out.println("\n\n");
		System.out.println("----------FoodZilla Family Restaurant - Admin Menu Section ----------");
