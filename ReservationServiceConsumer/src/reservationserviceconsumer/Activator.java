...
import reservationserviceproducer.ResturantServicePublish;
...
public class Activator implements BundleActivator {
	...
	public void start(BundleContext context) throws Exception {
		System.out.println("Reservation Consumer seervice started");
	...
	public void stop(BundleContext context) throws Exception {
		System.out.println("Reservation Consumer seervice stopped");
	...
	public void displayMainMenu(ResturantServicePublish resturantServicePublish) {
		...
		System.out.println("\n\n");
		System.out.println("----------FoodZilla Family Restaurant - Reservation ----------");
